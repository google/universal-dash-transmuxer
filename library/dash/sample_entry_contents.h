#ifndef _DASH2HLS_SAMPLE_ENTRY_CONTENTS_H_
#define _DASH2HLS_SAMPLE_ENTRY_CONTENTS_H_
...
class SampleEntryContents : public BoxContents {
 public:
  SampleEntryContents(uint32_t type, uint64_t stream_position)
