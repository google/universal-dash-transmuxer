#ifndef _DASH2HLS_MVHD_CONTENTS_H_
#define _DASH2HLS_MVHD_CONTENTS_H_
...
class MvhdContents : public FullBoxContents {
 public:
  explicit MvhdContents(uint64_t stream_position)
...
#endif  // _DASH2HLS_MVHD_CONTENTS_H_
